          ...
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              <Link href="/" className="flex-shrink-0 flex items-center">
                ...
                <h1 className="ml-2 text-xl font-bold text-gray-900 hidden sm:block">CareerPilot</h1>
              </Link>
            ...
            <div className="hidden md:ml-6 md:flex md:items-center space-x-4">
              ...
              <a
                href="#"
                className="text-white bg-blue-600 hover:bg-blue-700 px-4 py-2 rounded-md text-sm font-medium transition-colors duration-200"
              >
                Get Started
              </a>
            </div>
